...
[pg_engine, pg_conn, market_buys_table, players_table, pegas_table] = init_pg_db()
...
parse_transactions(contract_collection, pg_engine, pg_conn, market_buys_table, players_table, pegas_table)
